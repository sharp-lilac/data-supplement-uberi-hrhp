---
title: Creation of Boxplots for Healthy Reefs Report Card Supplementals - V5
...
setwd(dir = "G:\\Desktop\\Visualizations_HRI_Supps_UBERI_V5")
...
This script follows the documentation outlined in the following documents:
Percent Cover Indicator Calculations: Documentation ([link](https://docs.google.com/document/d/1lV0iiV39dHzlrbfm6SPQkZ2vGhDAud8T8uuxWaVE9E8/edit)), and Fish Biomass Indicator Calculations: Documentation ([link](https://docs.google.com/document/d/17I6XgVwByQbwM-08bCrHjQ8NEBqG97b1DWEQqzA94a4/edit)) to create transect-level observations of benthic cover and fish biomass. 


## 1 - Prepare the Data

The product of this step should be two dataframes: (1) df_benthic with Site, Subregion, Year, Coral, and Algae (where Coral and Algae represent the % coral and macroalgae cover by transect), and (2) df_fish with Site, Subregion, Year, Herb, and Comm (where Herb and Comm represent the fish biomass density by transect).

```{r data, message=FALSE, warning=FALSE, results='hide'}
# Prepare data #

#This code chunk shows how to generate the two dataframes using a reference sheet of site names and 2021 and 2023 benthci and fish data products. However, any input data may be used as long as it produces the stated dataframes. 
...
df_benthic =  Benthic_data_combined %>%
  mutate(Subregion = ifelse(Subregion == "Turneffe Atoll", "Turneffe", Subregion),
